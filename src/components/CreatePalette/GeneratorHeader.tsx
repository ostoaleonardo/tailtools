...
export function GeneratorHeader() {
    ...
    return (
        <header className='absolute top-[64px] w-full h-14 flex items-center justify-center border-x-black/5 border-y-1 transition-all z-10' style={{ backgroundColor: color.hex }}>
