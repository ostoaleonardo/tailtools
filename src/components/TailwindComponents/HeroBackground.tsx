export function HeroBackground() {
    return (
        <div className='absolute w-[100%] h-[100%] overflow-hidden z-0'>
            <svg
                aria-hidden='true'
                className='absolute w-screen h-[80%] inset-0 fill-black/[.1] stroke-black/[.1] dark:fill-white/[.1] dark:stroke-white/[.1] [mask-image:linear-gradient(to_bottom_right,white,transparent,transparent)] inset-x-0 skew-y-12'>
                <defs>
