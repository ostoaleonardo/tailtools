    ...
    return (
        ...
        >
            <CardHeader className='flex flex-col items-start p-6'>
                <h3 className='text-3xl font-bold bg-gradient-to-t from-foreground to-slate-400 bg-clip-text text-transparent transition-all'>{title}</h3>
                <p className='text-slate-700 dark:text-slate-200 transition-all'>{description}</p>
            </CardHeader>
