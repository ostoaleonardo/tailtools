        ...
        row.map((column, columnIndex) => {
            ...
            if (column && columnIndex === 0) {
                if (rowIndex === 0) {
                    ...
                    return `\t<div class='row-start-${rowIndex + 1}'>${rowIndex + ',' + columnIndex}</div>\n`
                }
            }
            ...
            if (column && columnIndex !== 0) {
                if (rowIndex === 0) {
                    return `\t<div class='col-start-${columnIndex + 1}'>${rowIndex + ',' + columnIndex}</div>\n`
                } else {
                    return `\t<div class='col-start-${columnIndex + 1} row-start-${rowIndex + 1}'>${rowIndex + ',' + columnIndex}</div>\n`
                }
            }
        })
    ))}
